...
public:
    // 保存和加载图书
    static bool save_books(const std::vector<Book>&books,const std::string& filename="data/books.txt");
    static bool load_books(std::vector<Book>&books,const std::string& filename = "data/books.txt");
    //保存何加载借阅数据
